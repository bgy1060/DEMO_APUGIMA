    ...
    <div class="row">
      <div class="col-lg-4-2 mb-4">
        <div class="card h-100">
          <a href="hospital_reviews.php" class="btn btn-primary"><h3>Hospital</h3>Manage my reviews</a>
        </div>
      </div>
      <div class="col-lg-4-2 mb-4">
        <div class="card h-100">
          <a href="medicine_reviews.php" class="btn"><h3>Medicine</h3>Manage my reviews</a>
        </div>
      </div>
    </div>
